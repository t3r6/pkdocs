...
function Hud:Render(delta)
	...
	if INP.Action(Actions.Forward) then
		local text = "^"
		HUD.PrintXY((w-HUD.GetTextWidth(text))/2,h-150,text,"timesbd",200,200,200,26)
	end
	if INP.Action(Actions.Backward) then
		local text = "v"
		HUD.PrintXY((w-HUD.GetTextWidth(text))/2,h-100,text,"timesbd",200,200,200,26)
	end
	if INP.Action(Actions.Jump) then
		local text = "J"
		HUD.PrintXY((w-HUD.GetTextWidth(text))/2,h-125,text,"timesbd",200,200,200,26)
	end
	if INP.Action(Actions.Left) then
		local text = "<"
		HUD.PrintXY((w-HUD.GetTextWidth(text))/2-25,h-125,text,"timesbd",200,200,200,26)
	end
	...
	if INP.Action(Actions.Fire) then
		local text = "O"
		HUD.PrintXY((w-HUD.GetTextWidth(text))/2-25,h-150,text,"timesbd",200,200,200,26)
	end
